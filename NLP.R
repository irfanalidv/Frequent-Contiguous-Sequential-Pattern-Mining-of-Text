Text_data <- c(d1="1.- What is Brainsfeed for?
               ...
               d4="4.-What are the benefits to becoming a Brainsfeeder?
               ...
               d5="5.-Why is Brainsfeed better than a typical survey or form builder?
               ...
               d6="6.-Will my project remain confidential?
               ...
               d7="7.-Can I manage who can see what?
               ...
               d8="8.-How long does it take to receive feedback?
               ...
               d9="9. Can I earn money as a Brainsfeeder?
               ...
               d10="10.-Can I manage the incentives for my project ?
...
parsedtxt <- spacy_parse(Text_data)
head(parsedtxt)

text_1<-spacy_parse(Text_data, tag = TRUE, entity = FALSE, lemma = FALSE)
head(text_1)

text_11<-spacy_parse(Text_data, tag = TRUE, entity = TRUE, lemma = TRUE)
head(text_11)

parsedtxt <- spacy_parse(Text_data, lemma = FALSE)
entity_extract_1<-entity_extract(parsedtxt)

entity_extract_2<-entity_extract(parsedtxt, type = "all")
